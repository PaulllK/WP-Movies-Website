<?php
define( 'POST_TYPE', 'dn_movies' );
define( 'RUNTIME', 'Runtime' );
define( 'TAXONOMY_YEARS', 'dn_movies-years' );
define( 'TAXONOMY_GENRES', 'dn_genres' );
define( 'POST_TYPE_ACTORS', 'dn_actors' );
define( 'POST_TYPE_DIRECTORS', 'dn_directors' );
define( 'MOVIE_ACTORS_CONNECTION', 'movies_actors' );
define( 'MOVIE_DIRECTORS_CONNECTION', 'movies_directors' );
